...
def main():
    ...
    ap.add_argument(
        ...
        type=int,
        default=0,
        help="Disable mask for ADC128D818 (bit i disables channel i)",
    )
    ap.add_argument(
        "--mode", type=int, default=0, help="Mode for ADC128D818 (0-3, see datasheet)"
    )
    ap.add_argument(
        "--cont",
        default=False,
        help="Continuous mode for ADC128D818",
        action="store_const",
        const=True,
    )
    ap.add_argument(
